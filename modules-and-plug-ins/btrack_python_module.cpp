...
{
    PyObject *hop_Size=NULL;
    PyObject *frame_Size=NULL;
    PyObject *df_Type=NULL;
    PyObject *arg1=NULL;
    PyObject *arr1=NULL;

    if (!PyArg_ParseTuple(args, "OOOO", &arg1, &hop_Size, &frame_Size, &df_Type))
    {
        return NULL;
    }
    ...
    ////////// BEGIN PROCESS ///////////////////
    //PyObject *hopSize PyObject *frameSize PyObject *df_type
    int hopSize = PyLong_AsLong(hop_Size);
    int frameSize = PyLong_AsLong(frame_Size);
    int df_type = PyLong_AsLong(df_Type);
    int numframes;
    double buffer[hopSize];	// buffer to hold one hopsize worth of audio samples
